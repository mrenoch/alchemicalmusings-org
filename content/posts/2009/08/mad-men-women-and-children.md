...
date: 2009-08-23T21:53:45
draft: false
slug: "mad-men-women-and-children"
url: "/2009/08/23/mad-men-women-and-children/"
categories:
  - "dangerousgifts"
  - "ethics"
  - "fire"
...
The show's format (very) closely resembles the hit TV show [House](http://www.fox.com/house/), except that Mental is set in a *nut*house. The show has received lukewarm [reviews](http://www.metacritic.com/tv/shows/mental) and mediocre [ratings](http://tvseriesfinale.com/articles/mental-cancel-or-keep/), but very well might get renewed. Mental health consumer advocates like ([pharma funded](http://namipharma.org/index.html)) NAMI have [not reached a consensus](http://www.nami.org/Template.cfm?Section=Stigma_Alerts_Archive&template=/contentmanagement/contentdisplay.cfm&ContentID=79925&title=NAMI%20StigmaBuster%20Alert%3A%20June%2011%2C%202009) on how to respond to these pop culture representations, and even the some of the radical [Icarus Project's](http://theicarusproject.net/) membership [were (initially) impressed](http://theicarusproject.net/forums/viewtopic.php?t=15357) by the show's message.
While this show might seem innocuous, it really deserves a careful, critical analysis. We seem to be approaching a turning point in perceptions around altered states, as powerful marketing forces are hard at work working to remove the stigma around mental "illness".  Brittany Spears was the unpaid celebrity spokesperson for the normlization of psychiatric crises, but Glenn Close will soon be leading up the [BringChange2Mind](http://www.bringchange2mind.com/) campaign.  Don't get me wrong — removing stigma is generally a good thing, but if the stigma is removed in order to increase the legitimacy of pharmaceutical treatments, the message (and outcome) is mixed.  We are all [dying, sick and crazy](http://alchemicalmusings.org/2007/06/13/we-are-all-dying-sick-and-crazy/).
I am reminded of a fantastic book I read last year called *[Freaks Talk Back](http://www.press.uchicago.edu/presssite/metadata.epl?mode=synopsis&bookkey=40916): Tabloid Talk Shows and Sexual Nonconformity*.  In this work, Joshua Gameson examines hundreds of hours of trashy talk show footage from the 80's and 90's - Ricki Lake, Montell Williams, Phil Donaue, Jerry Springer, the works. During the period examined, LGBT guests were featured regularly on these shows, amongst some of the [first representations](http://www.usc.edu/schools/annenberg/asc/projects/soin/enhancingCurricula/timeline.html) of gay people in mainstream popular culture.
...
I'm not sure if this kind of publicity is fooling anyone, but I am afraid it is. As folks like [smartmeme](http://www.smartmeme.org/) describe, narratives are often far more persuasive than stats, facts, or logic.
...
[For more critical clips from Mental S01E01 and S01E04 see [GenericPrescriptions](http://vimeo.com/user2201516/albums)].
