---
title: "Herding Anarchists"
date: 2009-02-26T01:15:59
draft: false
slug: "herding-anarchists"
url: "/2009/02/26/herding-anarchists/"
categories:
  - "ethics"
  - "freeculture"
  - "metaphysics"
...
This post, [*Sharing Code, for What its Worth*](http://kiloblog.com/post/sharing-code-for-what-its-worth/  ), does a great job explaining some of the advantages of distributed version control systems. Sometimes you just want to share/publish your work, not start a social movement. Sometimes you want to contribute back to a project w/out going through masonic hazing rituals. DVCS facilitates these interactions, far more easily than traditional centralized/hierarchical version control systems.
Wikipedia runs on a centralized version control system, but the Linux Kernel is developed on DVCS (as Linus Trovalds explains/insists himself [here](http://www.youtube.com/watch?v=4XpnKHJAok8)). We are just starting to use [github](http://github.com/) at work, and I have watched it increase the joy of sharing - reducing the disciplined overhead of perfecting software for an imagined speculative use and coordinating networks of trusted contributors. The practice really emphasizes the efficient laziness of agile programming, and helps you concentrate on what you need now, not what you think you might need later.
...
I think we can start to see hints of this approach breaking free from the software development world in this recent piece of intention-ware described in [Crowdsourcing the Filter](http://blog.ushahidi.com/index.php/2009/02/04/crisis-info-crowdsourcing-the-filter/).  (I met some of the Ushahidi team [earlier this year](http://mobileactive.org/open-mobile-consortium-meets-new-york) -  -and was impressed by how competent and grounded they seemed - tempering both the hype and nostalgia). As Benkler has [argued](http://yupnet.org/benkler/), ranking and filtering is itself just another information good, and amenable to peer production, but the best ways of organizing and coordinating - distributing and then reassebling - this production, still need to be worked out.
