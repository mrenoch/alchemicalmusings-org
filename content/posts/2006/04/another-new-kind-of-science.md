---
title: "Another New Kind of Science?"
date: 2006-04-03T23:25:00
draft: false
slug: "another-new-kind-of-science"
url: "/2006/04/03/another-new-kind-of-science/"
categories:
  - "air"
  - "epistemology"
tags: []
...
In a thought provoking post on the [future of science](http://www.edge.org/3rd_culture/kelly06/kelly06_index.html), Kelly enumerates many of the ways new computing paradigms and interactive forms of communications might transform science. The device that I am proposing here might lead to some of the outcomes Kelly proposes.
For a better idea of the kinds of visualization tools I am imagining, consider some of the [visualization work on large email corpora](http://alumni.media.mit.edu/%7Efviegas/research.html) coming out of the M.I.T. media lab, or the [history flow tool](http://researchweb.watson.ibm.com/history/) for analyzing wiki collaborations, but even the humble [tag cloud](http://en.wikipedia.org/wiki/Tag_cloud) could be adapted for these purposes, as [the power of words](http://infosthetics.com/archives/2006/02/power_of_words.html) and [visualizing the state of the union](http://infosthetics.com/archives/2005/12/parsing_state_of_the_union_visualization.html) demonstrate.
Crucially, tools analogous to [Plone's](http://plone.org) [haystack Product](http://projects.objectrealms.net/haystack) (built on top of the free [libots auto-classification/summarizer library](http://libots.sourceforge.net/)) might help do for social science research what auto-sequencing techniques have done for biology (when I was a kid, gene sequences needed to be painstakingly discovered "manually").
