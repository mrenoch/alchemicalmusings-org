---
title: "Wikibases and the Collaboration Index"
date: 2005-11-09T00:19:00
draft: false
slug: "wikibases-and-the-collaboration-index"
url: "/2005/11/09/wikibases-and-the-collaboration-index/"
categories:
  - "air"
  - "epistemology"
tags:
...
Sometime soon I plan on elaborating on ways in which software, as a form of creative expression, inevitably expresses the values of the creators in the form of features. But right now I want to focus on the [taxonomy of educational wiki implementations](http://ssad.bowdoin.edu:8668/space/CCNMTL+demo) that Mark has identified since he began working with them.
Here is how Mark divides up the space of educational wikis

- Repository/reference - eg [Wikipedia](http://wikipedia.org)

- A website whose primary function is to create a repository of knowledge on a particular topic.

- Gateway - eg [SaratogaCensus](http://academics.skidmore.edu/saratoga_census/wiki/index.php/Main_Page)

- A website whose primary function is to collect, assemble, and present references to external sources

- Simulation/role playing - eg [Holocaust Wiki](http://www.ahistoryteacher.com/holocaust/tiki-index.php)

- A "choose-your-own-adventure" style simulation/game environment

- 'Illuminated'/mark-up - eg The [Romantic Audience Projects](http://ssad.bowdoin.edu:8668/space/snipsnap-index)
...
In particular, I can think of a number of variations on the repository/reference wiki, where the final products might all look similar, but where the "collaboration index" might differ substantially (for more on the popularity of the repository/reference, see [Database as a Symbolic form](http://transcriptions.english.ucsb.edu/archive/courses/warner/english197/Schedule_files/Manovich/Database_as_symbolic_form.htm), Manovich 2001).
...
- A site like the [social justice wiki](http://socialjustice.ccnmtl.columbia.edu) where groups of 3-4 students each worked on a reference element of the site.
...
For more on this, see [Mark's comment's](http://www.columbia.edu/cgi-bin/ccnmtl/mt/mt-comments.cgi?entry_id=1382) on [CCNMTL's musings blog](http://ccnmtl.columbia.edu/services/musings/).
